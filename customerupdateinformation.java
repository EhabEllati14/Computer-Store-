...
public class customerupdateinformation {
	...
	customerupdateinformation(){
		...
		msg = new Label(" Are You Sure To Update Your Account ? ");
		...
		done.setFont(Font.font("BankGothic LT BT", FontWeight.SEMI_BOLD, FontPosture.ITALIC,18));
		done.setMinSize(150, 50);
		done.setStyle(
